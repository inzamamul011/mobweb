...
function warnIfAnchorIsHidden(positionAnchor, toast) {
  if (positionAnchor.offsetParent === null) {
    (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-toast] - The positionAnchor element for ion-toast was found in the DOM, but appears to be hidden. This may lead to unexpected positioning of the toast.', toast);
  }
}
/**
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const root = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_3__.g)(baseEl);
...
const createSwipeToDismissGesture = (el, toastPosition, onDismiss) => {
   ...
   */
  const wrapperEl = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_3__.g)(el).querySelector('.toast-wrapper');
  ...
  const swipeAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_8__.c)('toast-swipe-to-dismiss-animation').addElement(wrapperEl)
  /**
  ...
  const gesture = (0,_index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_10__.createGesture)({
    ...
    gesturePriority: _overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_5__.O,
    /**
...
const Toast = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionToastDidPresent", 7);
    this.willPresent = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionToastWillPresent", 7);
    this.willDismiss = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionToastWillDismiss", 7);
    this.didDismiss = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionToastDidDismiss", 7);
     ...
     */
    this.duration = _index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.e.getNumber('toastDuration', 0);
    /**
    ...
    this.createSwipeGesture = toastPosition => {
      const gesture = this.gesture = createSwipeToDismissGesture(this.el, toastPosition, () => {
         ...
         */
        this.dismiss(undefined, _overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_5__.G);
      });
      gesture.enable(true);
    };
    /**
  ...
  present() {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const animationPosition = getAnimationPosition(position, anchor, (0,_ionic_global_DfbeLwcV_js__WEBPACK_IMPORTED_MODULE_7__.b)(_this), el);
      /**
      ...
      yield (0,_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_5__.f)(_this, 'toastEnter', iosEnterAnimation, mdEnterAnimation, {
        position,
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const dismissed = yield (0,_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_5__.g)(_this2, data, role, 'toastLeave', iosLeaveAnimation, mdLeaveAnimation,
      /**
   ...
   */
  onDidDismiss() {
    return (0,_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionToastDidDismiss');
  }
  /**
   * Returns a promise that resolves when the toast will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_5__.h)(this.el, 'ionToastWillDismiss');
  }
  getButtons() {
  ...
  getAnchorElement() {
    ...
    if (position === 'middle' && positionAnchor !== undefined) {
      (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-toast] - The positionAnchor property is ignored when using position="middle".', this.el);
      return undefined;
    }
    if (typeof positionAnchor === 'string') {
      ...
      if (foundEl === null) {
        (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-toast] - An anchor element with an ID of "${positionAnchor}" was not found in the DOM.`, el);
        return undefined;
      }
      return foundEl;
    }
    ...
    (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-toast] - Invalid positionAnchor value:', positionAnchor, el);
    return undefined;
  }
  buttonClick(button) {
    var _this3 = this;
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (button === null || button === void 0 ? void 0 : button.handler) {
        ...
        try {
          ...
          (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.j)('[ion-toast] - Exception in callButtonHandler:', e);
        }
      }
      return true;
    })();
  ...
  renderButtons(buttons, side) {
    ...
    }, buttons.map(b => (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", Object.assign({}, b.htmlAttributes, {
      type: "button",
      class: buttonClass(b),
      tabIndex: 0,
    ...
    }), b.text), mode === 'md' && (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-ripple-effect", {
  ...
  render() {
    ...
    if (layout === 'stacked' && startButtons.length > 0 && endButtons.length > 0) {
      (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-toast] - This toast is using start and end buttons with the stacked toast layout. We recommend following the best practice of using either start or end buttons with the stacked toast layout.', el);
    }
    return (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
      ...
      part: "container"
    }, this.renderButtons(startButtons, 'start'), this.icon !== undefined && (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
...
const buttonPart = button => {
  return (0,_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_5__.i)(button.role) ? 'button cancel' : 'button';
};
Toast.style = {
  ios: toastIosCss(),
  md: toastMdCss()
