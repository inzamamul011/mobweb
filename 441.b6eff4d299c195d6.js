...
/* harmony import */ var _framework_delegate_CyxE1S_P_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./framework-delegate-CyxE1S_P.js */ 86398);
/* harmony import */ var _helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers-Tl8jw6S2.js */ 61371);
/* harmony import */ var _lock_controller_B_hirT0v_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lock-controller-B-hirT0v.js */ 87930);
/* harmony import */ var _capacitor_CFERIeaU_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./capacitor-CFERIeaU.js */ 16780);
/* harmony import */ var _overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./overlays-F8GHPo-e.js */ 53223);
/* harmony import */ var _theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./theme-DiVJyqlX.js */ 94576);
/* harmony import */ var _index_B_hkiOUh_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index-B-hkiOUh.js */ 115);
/* harmony import */ var _ionic_global_DfbeLwcV_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ionic-global-DfbeLwcV.js */ 27887);
/* harmony import */ var _keyboard_ywgs5efA_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./keyboard-ywgs5efA.js */ 13224);
/* harmony import */ var _animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./animation-CnGMT4ji.js */ 9616);
/* harmony import */ var _cubic_bezier_hHmYLOfE_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./cubic-bezier-hHmYLOfE.js */ 39166);
/* harmony import */ var _index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./index-CfgBF1SE.js */ 66011);
/* harmony import */ var _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./index-ZjP4CjeZ.js */ 99596);
/* harmony import */ var _hardware_back_button_CTe4XmL7_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./hardware-back-button-CTe4XmL7.js */ 46931);
/* harmony import */ var _gesture_controller_BTEOs1at_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./gesture-controller-BTEOs1at.js */ 58607);
/* harmony import */ var _keyboard_CUw4ekVy_js__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./keyboard-CUw4ekVy.js */ 19043);
...
const StatusBar = {
  ...
  getStyle: function () {
    var _ref = (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const engine = this.getEngine();
      if (!engine) {
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref2 = (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
    /**
     ...
     */
    const shouldDismiss = yield el.canDismiss(undefined, _overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.G);
    if (!shouldDismiss) {
      return;
    }
    /**
...
const createSwipeToCloseGesture = (el, animation, statusBarStyle, onDismiss, onDragStart, onDragMove, onDragEnd) => {
  ...
  let lastStep = 0;
  const getScrollY = () => {
    if (contentEl && (0,_index_hW6eNZ3o_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl)) {
  ...
  const canStart = detail => {
     ...
     */
    contentEl = (0,_index_hW6eNZ3o_js__WEBPACK_IMPORTED_MODULE_2__.f)(target);
    if (contentEl) {
      /**
       ...
       * asynchronous.
       */
      if ((0,_index_hW6eNZ3o_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl)) {
        const root = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.g)(contentEl);
  ...
  const onStart = detail => {
    ...
    if (deltaY > 0 && contentEl) {
      (0,_index_hW6eNZ3o_js__WEBPACK_IMPORTED_MODULE_2__.d)(contentEl);
    }
  ...
  const onMove = detail => {
    ...
    const clampedStep = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.e)(0.0001, processedStep, maxStep);
  ...
  const onEnd = detail => {
    ...
    if (contentEl) {
      (0,_index_hW6eNZ3o_js__WEBPACK_IMPORTED_MODULE_2__.r)(contentEl, initialScrollY);
    }
    animation.onFinish(() => {
      if (!shouldComplete) {
        gesture.enable(true);
  ...
  const gesture = (0,_index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_14__.createGesture)({
    ...
    gesturePriority: _overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.O,
    direction: 'y',
    threshold: 10,
    canStart,
    onStart,
...
const computeDuration = (remaining, velocity) => {
  return (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.e)(400, remaining / Math.abs(velocity * 1.1), 500);
};
/**
...
const createSheetEnterAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)('backdropAnimation').fromTo('opacity', 0, initialBackdrop);
  if (shouldShowBackdrop) {
    backdropAnimation.beforeStyles({
      'pointer-events': 'none'
    }).afterClearStyles(['pointer-events']);
  }
  const wrapperAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
   ...
   */
  const contentAnimation = !expandToScroll ? (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)('contentAnimation').keyframes([{
    offset: 0,
    opacity: 1,
...
const createSheetLeaveAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)('backdropAnimation').keyframes(backdropBreakpoint !== 0 ? customBackdrop : defaultBackdrop);
  const wrapperAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
    transform: `translateY(${100 - currentBreakpoint * 100}%)`
...
const createEnterAnimation$1 = () => {
  const backdropAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
  const wrapperAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
  return {
    backdropAnimation,
    wrapperAnimation,
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const root = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.g)(baseEl);
  const {
    wrapperAnimation,
    backdropAnimation,
    contentAnimation
  ...
  const baseAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)('entering-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation([wrapperAnimation]);
  if (contentAnimation) {
  ...
  if (presentingEl) {
    ...
    const presentingElRoot = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
    const presentingAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeStyles({
    ...
    if (isPortrait) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().afterStyles({
          transform: finalTransform
...
const createLeaveAnimation$1 = () => {
  const backdropAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('opacity', 'var(--backdrop-opacity)', 0);
  const wrapperAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
  return {
    backdropAnimation,
    wrapperAnimation
  };
...
const iosLeaveAnimation = (baseEl, opts, duration = 500) => {
  ...
  const baseAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)('leaving-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);
  if (presentingEl) {
    const isPortrait = window.innerWidth < 768;
    const hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    const presentingElRoot = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
    const presentingAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(currentStep => {
    ...
    if (isPortrait) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(presentingElRoot.querySelector('.modal-shadow')).afterStyles({
          transform: 'translateY(0) scale(1)'
        }).keyframes([{
          offset: 0,
          opacity: '0',
...
const portraitToLandscapeTransition = (baseEl, opts, duration = 300) => {
  ...
  if (!presentingEl) {
    ...
    return (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)('portrait-to-landscape-transition');
  }
  const presentingElIsCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
  const presentingElRoot = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
  const bodyEl = document.body;
  const baseAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)('portrait-to-landscape-transition').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration);
  const presentingAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeStyles({
    transform: 'translateY(0)',
    'transform-origin': 'top center',
    overflow: 'hidden'
  ...
  if (!presentingElIsCardModal) {
    ...
    const root = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.g)(baseEl);
    const wrapperAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(root.querySelectorAll('.modal-wrapper, .modal-shadow')).fromTo('opacity', '1', '1'); // Keep wrapper visible in landscape
    const backdropAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 'var(--backdrop-opacity)'); // Keep backdrop visible
...
const landscapeToPortraitTransition = (baseEl, opts, duration = 300) => {
  ...
  if (!presentingEl) {
    // No transition needed for non-card modals
    return (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)('landscape-to-portrait-transition');
  }
  const presentingElIsCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
  const presentingElRoot = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
  const bodyEl = document.body;
  const baseAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)('landscape-to-portrait-transition').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration);
  const presentingAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeStyles({
    transform: 'translateY(0)',
    'transform-origin': 'top center',
    overflow: 'hidden'
  ...
  if (!presentingElIsCardModal) {
    ...
    // need to care about layering and modal-specific styles.
    const root = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.g)(baseEl);
    const wrapperAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(root.querySelectorAll('.modal-wrapper, .modal-shadow')).fromTo('opacity', '1', '1'); // Keep wrapper visible
    const backdropAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 'var(--backdrop-opacity)'); // Keep backdrop visible
...
const createEnterAnimation = () => {
  ...
  const wrapperAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().keyframes([{
    offset: 0,
    opacity: 0.01,
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  // all the breakpoints.
  !expandToScroll && (contentAnimation === null || contentAnimation === void 0 ? void 0 : contentAnimation.addElement(baseEl.querySelector('.ion-page')));
  const baseAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(baseEl).easing('cubic-bezier(0.36,0.66,0.04,1)').duration(280).addAnimation([backdropAnimation, wrapperAnimation]);
  if (contentAnimation) {
    baseAnimation.addAnimation(contentAnimation);
  }
  return baseAnimation;
...
const mdLeaveAnimation = (baseEl, opts) => {
  ...
  backdropAnimation.addElement(root.querySelector('ion-backdrop'));
  wrapperAnimation.addElement(root.querySelector('.modal-wrapper'));
  const baseAnimation = (0,_animation_CnGMT4ji_js__WEBPACK_IMPORTED_MODULE_12__.c)().easing('cubic-bezier(0.47,0,0.745,0.715)').duration(200).addAnimation([backdropAnimation, wrapperAnimation]);
  return baseAnimation;
};
const createSheetGesture = (baseEl, backdropEl, wrapperEl, initialBreakpoint, backdropBreakpoint, animation, breakpoints = [], expandToScroll, getCurrentBreakpoint, onDismiss, onBreakpointChange, onDragStart, onDragMove, onDragEnd) => {
  ...
  const enableBackdrop = () => {
     ...
     * the sheet.
     */
    baseEl.classList.remove(_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.F);
  };
  const disableBackdrop = () => {
     ...
     */
    baseEl.classList.add(_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.F);
  };
  /**
  ...
  const canStart = detail => {
     ...
     */
    const contentEl = (0,_index_hW6eNZ3o_js__WEBPACK_IMPORTED_MODULE_2__.f)(detail.event.target);
    ...
    if (!expandToScroll && contentEl) {
      const scrollEl = (0,_index_hW6eNZ3o_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl) ? (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.g)(contentEl).querySelector('.inner-scroll') : contentEl;
  ...
  const onStart = detail => {
     ...
     */
    if (!expandToScroll) {
      const targetEl = (0,_index_hW6eNZ3o_js__WEBPACK_IMPORTED_MODULE_2__.f)(detail.event.target);
      cachedScrollEl = targetEl && (0,_index_hW6eNZ3o_js__WEBPACK_IMPORTED_MODULE_2__.i)(targetEl) ? (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.g)(targetEl).querySelector('.inner-scroll') : targetEl;
    }
    /**
    ...
    (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => {
      /**
  ...
  const onMove = detail => {
    ...
    offset = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.e)(0.0001, processedStep, maxStep);
...
const isCenteredDialogViewport = () => {
  if (!_index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__.w) return false;
  return _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__.w.matchMedia(`(min-width: ${MODAL_INSET_MIN_WIDTH}px) and (min-height: ${MODAL_INSET_MIN_HEIGHT}px)`).matches;
};
/**
...
const getRootSafeAreaTop = () => {
  ...
  const doc = _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__.w === null || _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__.w === void 0 ? void 0 : _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__.w.document;
...
const getPositionBasedSafeAreaConfig = wrapperEl => {
  ...
  const vh = (_a = _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__.w === null || _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__.w === void 0 ? void 0 : _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__.w.innerHeight) !== null && _a !== void 0 ? _a : 0;
  const vw = (_b = _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__.w === null || _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__.w === void 0 ? void 0 : _index_ZjP4CjeZ_js__WEBPACK_IMPORTED_MODULE_15__.w.innerWidth) !== null && _b !== void 0 ? _b : 0;
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionModalDidPresent", 7);
    this.willPresent = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionModalWillPresent", 7);
    this.willDismiss = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionModalWillDismiss", 7);
    this.didDismiss = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionModalDidDismiss", 7);
    this.ionBreakpointDidChange = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionBreakpointDidChange", 7);
    ...
    this.ionMount = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionMount", 7);
    this.ionDragStart = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionDragStart", 7);
    this.ionDragMove = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionDragMove", 7);
    this.ionDragEnd = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionDragEnd", 7);
    this.lockController = (0,_lock_controller_B_hirT0v_js__WEBPACK_IMPORTED_MODULE_5__.c)();
    this.triggerController = (0,_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.e)();
    this.coreDelegate = (0,_framework_delegate_CyxE1S_P_js__WEBPACK_IMPORTED_MODULE_3__.C)();
    ...
    this.onBackdropTap = () => {
      ...
      this.dismiss(undefined, _overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.B);
    };
  ...
  connectedCallback() {
    ...
    (0,_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.j)(el);
    this.triggerChanged();
  }
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.b)(el, attributesToInherit);
    ...
    if (breakpoints !== undefined && initialBreakpoint !== undefined && !breakpoints.includes(initialBreakpoint)) {
      (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-modal] - Your breakpoints array must include the initialBreakpoint value.');
    }
    if (!((_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id)) {
      (0,_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.k)(this.el);
    }
  }
  componentDidLoad() {
    /**
     ...
     */
    if (this.isOpen === true) {
      (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => this.present());
    }
  ...
  present() {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_CyxE1S_P_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, el, _this2.component, ['ion-page'], _this2.componentProps, inline);
      /**
       ...
       */
      if ((0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.h)(el)) {
        yield (0,_index_B_hkiOUh_js__WEBPACK_IMPORTED_MODULE_9__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_B_hkiOUh_js__WEBPACK_IMPORTED_MODULE_9__.w)();
      }
      (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => _this2.el.classList.add('show-modal'));
      ...
      _this2.isSheetModal = _this2.breakpoints !== undefined && _this2.initialBreakpoint !== undefined;
      // Set initial safe-area overrides before animation
      _this2.setInitialSafeAreaOverrides();
       ...
       */
      if (hasCardModal && (0,_ionic_global_DfbeLwcV_js__WEBPACK_IMPORTED_MODULE_10__.b)(_this2) === 'ios') {
        // Cache the original status bar color before the modal is presented
        _this2.statusBarStyle = yield StatusBar.getStyle();
        setCardStatusBarDark();
      }
      yield (0,_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.f)(_this2, 'modalEnter', iosEnterAnimation, mdEnterAnimation, {
      ...
      _this2.updateSafeAreaOverrides();
      // Apply fullscreen safe-area padding if needed
      _this2.applyFullscreenSafeArea();
  ...
  initSwipeToClose() {
    var _a;
    if ((0,_ionic_global_DfbeLwcV_js__WEBPACK_IMPORTED_MODULE_10__.b)(this) !== 'ios') {
      return;
    }
    const {
      el
    ...
    const animationBuilder = this.leaveAnimation || _index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.e.get('modalLeave', iosLeaveAnimation);
    const ani = this.animation = animationBuilder(el, {
      presentingEl: this.presentingElement,
      expandToScroll: this.expandToScroll
    });
    const contentEl = (0,_index_hW6eNZ3o_js__WEBPACK_IMPORTED_MODULE_2__.a)(el);
    if (!contentEl) {
      (0,_index_hW6eNZ3o_js__WEBPACK_IMPORTED_MODULE_2__.p)(el);
      return;
    }
  ...
  initSheetGesture() {
    ...
    const animationBuilder = this.enterAnimation || _index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.e.get('modalEnter', iosEnterAnimation);
  ...
  sheetOnDismiss() {
    ...
    this.animation.onFinish(/*#__PURE__*/(0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this3.currentBreakpoint = 0;
      _this3.ionBreakpointDidChange.emit({
        breakpoint: _this3.currentBreakpoint
      });
      yield _this3.dismiss(undefined, _overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.G);
  ...
  cardOnDismiss() {
    ...
    this.animation.onFinish(/*#__PURE__*/(0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _this4.dismiss(undefined, _overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.G);
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var _a;
      if (_this5.gestureAnimationDismissing && role !== _overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.G) {
        return false;
      }
      // Cancel any pending resize timeout to prevent stale updates during dismiss
      clearTimeout(_this5.resizeTimeout);
      _this5.resizeTimeout = undefined;
      /**
       ...
       */
      const hasCardModal = presentingElement !== undefined;
      if (hasCardModal && (0,_ionic_global_DfbeLwcV_js__WEBPACK_IMPORTED_MODULE_10__.b)(_this5) === 'ios') {
      ...
      const dismissed = yield (0,_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.g)(_this5, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, {
        presentingEl: presentingElement,
      ...
      if (dismissed) {
        ...
        yield (0,_framework_delegate_CyxE1S_P_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this5.usersElement);
        (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => _this5.el.classList.remove('show-modal'));
        if (_this5.animation) {
        ...
        _this5.cleanupSafeAreaOverrides();
   ...
   */
  onDidDismiss() {
    return (0,_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.h)(this.el, 'ionModalDidDismiss');
  }
  /**
   * Returns a promise that resolves when the modal will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.h)(this.el, 'ionModalWillDismiss');
  }
  /**
  ...
  setCurrentBreakpoint(breakpoint) {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this6.isSheetModal) {
        (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-modal] - setCurrentBreakpoint is only supported on sheet modals.');
        return;
      }
      if (!_this6.breakpoints.includes(breakpoint)) {
        (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-modal] - Attempted to set invalid breakpoint value ${breakpoint}. Please double check that the breakpoint value is part of your defined breakpoints.`);
        return;
      }
      const {
        currentBreakpoint,
  ...
  initViewTransitionListener() {
    ...
    if ((0,_ionic_global_DfbeLwcV_js__WEBPACK_IMPORTED_MODULE_10__.b)(this) !== 'ios' || !this.presentingElement || this.enterAnimation || this.leaveAnimation) {
      return;
    }
  ...
  handleViewTransition() {
    ...
    transitionAnimation.play().then(() => {
      ...
      (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => this.updateSafeAreaOverrides());
  ...
  reinitSwipeToClose() {
    ...
    if ((0,_ionic_global_DfbeLwcV_js__WEBPACK_IMPORTED_MODULE_10__.b)(this) !== 'ios' || !this.presentingElement) {
      return;
    }
  ...
  ensureCorrectModalPosition() {
    ...
    const root = (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.g)(el);
  ...
  dismissNestedModals() {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      nestedModals === null || nestedModals === void 0 ? void 0 : nestedModals.forEach(/*#__PURE__*/function () {
        var _ref5 = (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (modal) {
  ...
  getSafeAreaContext() {
    return {
      ...
      isCardModal: this.presentingElement !== undefined && (0,_ionic_global_DfbeLwcV_js__WEBPACK_IMPORTED_MODULE_10__.b)(this) === 'ios',
  ...
  setInitialSafeAreaOverrides() {
    const context = Object.assign(Object.assign({}, this.getSafeAreaContext()), {
  ...
  findContentAndFooter() {
    ...
    for (const child of Array.from(this.el.children)) {
      if (child.tagName === 'ION-CONTENT') contentEl = child;
      if (child.tagName === 'ION-FOOTER') hasFooter = true;
      for (const grandchild of Array.from(child.children)) {
        if (grandchild.tagName === 'ION-CONTENT' && !contentEl) contentEl = grandchild;
  ...
  render() {
    ...
    const mode = (0,_ionic_global_DfbeLwcV_js__WEBPACK_IMPORTED_MODULE_10__.b)(this);
    ...
    return (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
      key: '4bf38aa67df9a3f977163bba5423960bbafd16de',
      "no-router": true,
      ...
      class: Object.assign({
        ...
        'overlay-hidden': true,
        [_overlays_F8GHPo_e_js__WEBPACK_IMPORTED_MODULE_7__.F]: focusTrap === false
      ...
      key: '866da40cc5fc8d3e36637098fb3066a5bc9f4e0f',
      ref: el => this.backdropEl = el,
      visible: this.showBackdrop,
      tappable: this.backdropDismiss,
      part: "backdrop"
    }), mode === 'ios' && (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: '5a2a05514ea8592c8feb0465e504aa7c7af17963',
      class: "modal-shadow"
    }), (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", Object.assign({
      ...
      */
    ...
    }), showHandle && (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      key: 'd1882835cc049232c0d957e3ba1e79676a07d179',
      class: "modal-handle",
      ...
      key: '81dc58b09cf7d7022b04cd170f53113604364d5e',
