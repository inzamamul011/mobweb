...
/* harmony import */ var _hardware_back_button_Dhbd_23H_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hardware-back-button-Dhbd-23H.js */ 46569);
/* harmony import */ var _ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ionic-global-CTSyufhF.js */ 32678);
...
/* harmony import */ var _index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./index-7UbSlv7N.js */ 17694);
...
/* harmony import */ var _framework_delegate_BLEBgH06_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./framework-delegate-BLEBgH06.js */ 61438);
...
/* harmony import */ var _index_Dp7GXH1z_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./index-Dp7GXH1z.js */ 75355);
...
const App = class {
  ...
  componentDidLoad() {
    var _this = this;
    {
      rIC(/*#__PURE__*/(0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        const isHybrid = (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_3__.a)(window, 'hybrid');
        if (!_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.e.getBoolean('_testing')) {
          __webpack_require__.e(/*! import() */ 4004).then(__webpack_require__.bind(__webpack_require__, /*! ./index-C6WeRr09.js */ 54004)).then(module => module.startTapClick(_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.e));
        }
        if (_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.e.getBoolean('statusTap', isHybrid)) {
          __webpack_require__.e(/*! import() */ 5168).then(__webpack_require__.bind(__webpack_require__, /*! ./status-tap-pATNXEtr.js */ 5168)).then(module => module.startStatusTap());
        }
        if (_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.e.getBoolean('inputShims', needInputShims())) {
          /**
           * needInputShims() ensures that only iOS and Android
           * platforms proceed into this block.
           */
          const platform = (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_3__.a)(window, 'ios') ? 'ios' : 'android';
          __webpack_require__.e(/*! import() */ 5127).then(__webpack_require__.bind(__webpack_require__, /*! ./input-shims-C4KDnhxb.js */ 55127)).then(module => module.startInputShims(_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.e, platform));
        }
        const hardwareBackButtonModule = yield Promise.resolve(/*! import() */).then(__webpack_require__.bind(__webpack_require__, /*! ./hardware-back-button-Dhbd-23H.js */ 46569));
        const supportsHardwareBackButtonEvents = isHybrid || (0,_hardware_back_button_Dhbd_23H_js__WEBPACK_IMPORTED_MODULE_2__.shouldUseCloseWatcher)();
        if (_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.e.getBoolean('hardwareBackButton', supportsHardwareBackButtonEvents)) {
           ...
           */
          if ((0,_hardware_back_button_Dhbd_23H_js__WEBPACK_IMPORTED_MODULE_2__.shouldUseCloseWatcher)()) {
            (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-app] - experimentalCloseWatcher was set to `true`, but hardwareBackButton was set to `false`. Both config options must be `true` for the Close Watcher API to be used.');
          }
  ...
  render() {
    ...
    return (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      ...
      class: {
        [mode]: true,
        'ion-page': true,
        'force-statusbar-padding': _index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.e.getBoolean('_forceStatusbarPadding')
      }
    });
  }
  get el() {
...
const needInputShims = () => {
   ...
   */
  const needsShimsIOS = (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_3__.a)(window, 'ios') && (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_3__.a)(window, 'mobile');
  if (needsShimsIOS) {
    return true;
  }
  /**
   ...
   */
  const isAndroidMobileWeb = (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_3__.a)(window, 'android') && (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_3__.a)(window, 'mobileweb');
...
const Content = class {
  constructor(hostRef) {
    (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    this.ionScrollStart = (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionScrollStart", 7);
    this.ionScroll = (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionScroll", 7);
    this.ionScrollEnd = (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionScrollEnd", 7);
    this.watchDog = null;
  ...
  componentWillLoad() {
    this.inheritedAttributes = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.i)(this.el);
  }
  connectedCallback() {
     ...
     */
    if ((0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.h)(this.el)) {
      /**
  ...
  shouldForceOverscroll() {
    ...
    const mode = (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_3__.b)(this);
    return forceOverscroll === undefined ? mode === 'ios' && (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_3__.a)('ios') : forceOverscroll;
  }
  resize() {
    /**
    ...
    {
      if (this.fullscreen) {
        (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.a)(() => this.readDimensions());
      } else if (this.cTop !== 0 || this.cBottom !== 0) {
        this.cTop = this.cBottom = 0;
        (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.i)(this);
      }
    }
  }
  readDimensions() {
  ...
  onScroll(ev) {
    ...
    if (!this.queued && this.scrollEvents) {
      this.queued = true;
      (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.a)(ts => {
        this.queued = false;
  ...
  getScrollElement() {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
       ...
       */
      if (!_this3.scrollEl) {
        yield new Promise(resolve => (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.c)(_this3.el, resolve));
      }
  ...
  getBackgroundElement() {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this4.backgroundContentEl) {
        yield new Promise(resolve => (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.c)(_this4.el, resolve));
      }
  ...
  scrollToBottom() {
    var _this5 = this;
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (duration = 0) {
  ...
  scrollToPoint(_x, _x2) {
    var _this7 = this;
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (x, y, duration = 0) {
  ...
  render() {
    ...
    return (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
      ...
      part: "background"
    }), fixedSlotPlacement === 'before' ? (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      name: "fixed"
    }) : null, (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
    ...
    })), transitionShadow ? (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "transition-effect"
    }, (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "transition-cover"
    }), (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      class: "transition-shadow"
    })) : null, fixedSlotPlacement === 'after' ? (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
      name: "fixed"
    }) : null);
  }
  get el() {
...
const handleFooterFade = (scrollEl, baseEl) => {
  (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.a)(() => {
    ...
    const scale = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.e)(0, 1 - distanceToStart / fadeDuration, 1);
...
const Footer = class {
  constructor(hostRef) {
    ...
    this.checkCollapsibleFooter = () => {
      ...
      if (hasFade) {
        ...
        const contentEl = pageEl ? (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_7__.a)(pageEl) : null;
        if (!contentEl) {
          (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_7__.p)(this.el);
          return;
        }
    ...
    this.setupFadeFooter = /*#__PURE__*/function () {
      var _ref2 = (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl) {
        const scrollEl = _this8.scrollEl = yield (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_7__.g)(contentEl);
        /**
  ...
  connectedCallback() {
    var _this9 = this;
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this9.keyboardCtrl = yield (0,_keyboard_controller_BaaVITYt_js__WEBPACK_IMPORTED_MODULE_8__.c)(/*#__PURE__*/function () {
        var _ref3 = (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (keyboardOpen, waitForResize) {
          /**
  ...
  render() {
    ...
    }, mode === 'ios' && translucent && (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
const handleContentScroll = (scrollEl, scrollHeaderIndex, contentEl) => {
  (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.a)(() => {
    const scrollTop = scrollEl.scrollTop;
    const scale = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.e)(1, 1 + -scrollTop / 500, 1.1);
...
const handleHeaderFade = (scrollEl, baseEl, condenseHeader) => {
  (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.a)(() => {
    ...
    const distanceToStart = scrollTop - fadeStart;
    const fadeDuration = 10;
    const scale = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.e)(0, distanceToStart / fadeDuration, 1);
    (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => {
...
const Header = class {
  constructor(hostRef) {
    ...
    this.setupFadeHeader = /*#__PURE__*/function () {
      var _ref4 = (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (contentEl, condenseHeader) {
        const scrollEl = _this0.scrollEl = yield (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_7__.g)(contentEl);
        /**
         * Handle fading of toolbars on scroll
         */
  ...
  checkCollapsibleHeader() {
    var _this1 = this;
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const mode = (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_3__.b)(_this1);
      if (mode !== 'ios') {
        return;
      }
      const {
      ...
      if (hasCondense) {
        ...
        const contentEl = pageEl ? (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_7__.a)(pageEl) : null;
        if (!contentEl) {
          (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_7__.p)(_this1.el);
          return;
        }
  ...
  setupCondenseHeader(contentEl, pageEl) {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!contentEl || !pageEl) {
        (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_7__.p)(_this10.el);
        return;
      }
      if (typeof IntersectionObserver === 'undefined') {
        return;
      }
      _this10.scrollEl = yield (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_7__.g)(contentEl);
  ...
  render() {
    ...
    const roleType = (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_6__.h)('ion-menu', this.el) ? 'none' : 'banner';
    return (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
    ...
    }, inheritedAttributes), mode === 'ios' && translucent && (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
...
const RouterOutlet = class {
  constructor(hostRef) {
    (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.r)(this, hostRef);
    this.ionNavWillLoad = (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionNavWillLoad", 7);
    this.ionNavWillChange = (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionNavWillChange", 3);
    this.ionNavDidChange = (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionNavDidChange", 3);
    this.lockController = (0,_lock_controller_B_hirT0v_js__WEBPACK_IMPORTED_MODULE_11__.c)();
    this.gestureOrAnimationInProgress = false;
    /**
     * The mode determines which platform styles to use.
     */
    this.mode = (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_3__.b)(this);
    /**
  ...
  connectedCallback() {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this11.gesture = (yield __webpack_require__.e(/*! import() */ 2076).then(__webpack_require__.bind(__webpack_require__, /*! ./swipe-back-B2YfOHRM.js */ 81285))).createSwipeBackGesture(_this11.el, () => !_this11.gestureOrAnimationInProgress && !!_this11.swipeHandler && _this11.swipeHandler.canStart(), () => onStart(), step => {
        var _a;
  ...
  commit(enteringEl, leavingEl, opts) {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      try {
        ...
        (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.j)('[ion-router-outlet] - Exception in commit:', e);
      }
      unlock();
      return changed;
    })();
  ...
  setRoot(component, params, opts) {
    var _this15 = this;
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (_this15.activeComponent === component && (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.s)(params, _this15.activeParams)) {
        return false;
      }
      // attach entering view to DOM
      const leavingEl = _this15.activeEl;
      const enteringEl = yield (0,_framework_delegate_BLEBgH06_js__WEBPACK_IMPORTED_MODULE_10__.a)(_this15.delegate, _this15.el, component, ['ion-page', 'ion-page-invisible'], params);
      ...
      yield (0,_framework_delegate_BLEBgH06_js__WEBPACK_IMPORTED_MODULE_10__.d)(_this15.delegate, leavingEl);
      return true;
    })();
  }
  transition(_x8, _x9) {
    var _this16 = this;
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (enteringEl, leavingEl, opts = {}) {
      ...
      const animated = _this16.animated && _index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.e.getBoolean('animated', true);
      const animationBuilder = opts.animationBuilder || _this16.animation || _index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.e.get('navAnimation');
      yield (0,_index_Dp7GXH1z_js__WEBPACK_IMPORTED_MODULE_12__.t)(Object.assign(Object.assign({
        mode,
        animated,
        enteringEl,
        leavingEl,
         ...
         * loaded bundle.
         */
        deepWait: (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.h)(el),
