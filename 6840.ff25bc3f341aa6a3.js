...
const Picker = class {
  constructor(hostRef) {
    ...
    this.ionInputModeChange = (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionInputModeChange", 7);
  ...
  componentWillLoad() {
    (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).addEventListener('focusin', this.onFocusIn);
    (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_2__.g)(this.el).addEventListener('focusout', this.onFocusOut);
  }
  /**
   * @internal
