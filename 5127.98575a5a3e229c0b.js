"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([[5127],{
...
/* harmony import */ var _keyboard_CUw4ekVy_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./keyboard-CUw4ekVy.js */ 19043);
/* harmony import */ var _index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index-4DxY6_gG.js */ 33304);
...
const enableHideCaretOnScroll = (componentEl, inputEl, scrollEl) => {
  ...
  (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_3__.f)(scrollEl, 'ionScrollStart', hideCaret);
  (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_3__.f)(scrollEl, 'ionScrollEnd', showCaret);
  inputEl.addEventListener('blur', onBlur);
  return () => {
    (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_3__.m)(scrollEl, 'ionScrollStart', hideCaret);
    (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_3__.m)(scrollEl, 'ionScrollEnd', showCaret);
...
const enableInputBlurring = () => {
  ...
  (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_3__.f)(doc, 'ionScrollStart', onScroll);
  doc.addEventListener('focusin', onFocusin, true);
  doc.addEventListener('touchend', onTouchend, false);
  return () => {
    (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_3__.m)(doc, 'ionScrollStart', onScroll, true);
...
const jsSetFocus = /*#__PURE__*/function () {
  var _ref2 = (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (componentEl, inputEl, contentEl, footerEl, keyboardHeight, enableScrollPadding, disableClonedInput = false, platformHeight = 0, waitForResize = true) {
     ...
     */
    (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_3__.r)(() => componentEl.click());
    /**
    ...
    if (typeof window !== 'undefined') {
      ...
      const _scrollContent = /*#__PURE__*/function () {
        var _ref3 = (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
          ...
          if (contentEl) {
            yield (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.c)(contentEl, 0, scrollData.scrollAmount, scrollData.scrollDuration);
          }
      ...
      if (contentEl) {
        const scrollEl = yield (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.g)(contentEl);
        /**
...
const startInputShims = /*#__PURE__*/function () {
  var _ref4 = (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (config, platform) {
    /**
    ...
    const registerInput = /*#__PURE__*/function () {
      var _ref5 = (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (componentEl) {
        yield new Promise(resolve => (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_3__.c)(componentEl, resolve));
        const inputRoot = componentEl.shadowRoot || componentEl;
        const inputEl = inputRoot.querySelector('input') || inputRoot.querySelector('textarea');
        const scrollEl = (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.f)(componentEl);
