...
/* harmony import */ var _index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-7UbSlv7N.js */ 17694);
/* harmony import */ var _framework_delegate_BLEBgH06_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./framework-delegate-BLEBgH06.js */ 61438);
/* harmony import */ var _helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers-8KSQQGQy.js */ 19358);
...
/* harmony import */ var _overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./overlays-ZX_4-t_r.js */ 78596);
/* harmony import */ var _theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./theme-DiVJyqlX.js */ 94576);
/* harmony import */ var _index_Dp7GXH1z_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./index-Dp7GXH1z.js */ 75355);
/* harmony import */ var _ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ionic-global-CTSyufhF.js */ 32678);
/* harmony import */ var _keyboard_ywgs5efA_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./keyboard-ywgs5efA.js */ 13224);
/* harmony import */ var _animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./animation-BvhAtgca.js */ 83790);
...
/* harmony import */ var _hardware_back_button_Dhbd_23H_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./hardware-back-button-Dhbd-23H.js */ 46569);
...
const handleCanDismiss = /*#__PURE__*/function () {
  var _ref2 = (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el, animation) {
     ...
     */
    const shouldDismiss = yield el.canDismiss(undefined, _overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.G);
    if (!shouldDismiss) {
      return;
    }
    /**
...
const createSwipeToCloseGesture = (el, animation, statusBarStyle, onDismiss) => {
  ...
  let lastStep = 0;
  const getScrollY = () => {
    if (contentEl && (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl)) {
  ...
  const canStart = detail => {
     ...
     */
    contentEl = (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.f)(target);
    if (contentEl) {
      /**
       ...
       * asynchronous.
       */
      if ((0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl)) {
        const root = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.g)(contentEl);
  ...
  const onStart = detail => {
    ...
    if (deltaY > 0 && contentEl) {
      (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.d)(contentEl);
    }
  ...
  const onMove = detail => {
    ...
    const clampedStep = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.e)(0.0001, processedStep, maxStep);
  ...
  const onEnd = detail => {
    ...
    if (contentEl) {
      (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.r)(contentEl, initialScrollY);
    }
    animation.onFinish(() => {
      if (!shouldComplete) {
        gesture.enable(true);
  ...
  const gesture = (0,_index_CfgBF1SE_js__WEBPACK_IMPORTED_MODULE_14__.createGesture)({
    ...
    gesturePriority: _overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.O,
    direction: 'y',
    threshold: 10,
    canStart,
    onStart,
...
const computeDuration = (remaining, velocity) => {
  return (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.e)(400, remaining / Math.abs(velocity * 1.1), 500);
};
const createSheetEnterAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)('backdropAnimation').fromTo('opacity', 0, initialBackdrop);
  if (shouldShowBackdrop) {
    backdropAnimation.beforeStyles({
      'pointer-events': 'none'
    }).afterClearStyles(['pointer-events']);
  }
  const wrapperAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
   ...
   */
  const contentAnimation = !expandToScroll ? (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)('contentAnimation').keyframes([{
    offset: 0,
    opacity: 1,
...
const createSheetLeaveAnimation = opts => {
  ...
  const backdropAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)('backdropAnimation').keyframes(backdropBreakpoint !== 0 ? customBackdrop : defaultBackdrop);
  const wrapperAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)('wrapperAnimation').keyframes([{
    offset: 0,
    opacity: 1,
    transform: `translateY(${100 - currentBreakpoint * 100}%)`
...
const createEnterAnimation$1 = () => {
  const backdropAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
    'pointer-events': 'none'
  }).afterClearStyles(['pointer-events']);
  const wrapperAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
  return {
    backdropAnimation,
    wrapperAnimation,
...
const iosEnterAnimation = (baseEl, opts) => {
  ...
  const root = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.g)(baseEl);
  const {
    wrapperAnimation,
    backdropAnimation,
    contentAnimation
  ...
  const baseAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)('entering-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation([wrapperAnimation]);
  if (contentAnimation) {
  ...
  if (presentingEl) {
    ...
    const presentingElRoot = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
    const presentingAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeStyles({
    ...
    if (isPortrait) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().afterStyles({
          transform: finalTransform
...
const createLeaveAnimation$1 = () => {
  const backdropAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('opacity', 'var(--backdrop-opacity)', 0);
  const wrapperAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
  return {
    backdropAnimation,
    wrapperAnimation
  };
...
const iosLeaveAnimation = (baseEl, opts, duration = 500) => {
  ...
  const baseAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)('leaving-base').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);
  if (presentingEl) {
    const isPortrait = window.innerWidth < 768;
    const hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
    const presentingElRoot = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
    const presentingAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(currentStep => {
    ...
    if (isPortrait) {
      ...
      if (!hasCardModal) {
        ...
        const shadowAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(presentingElRoot.querySelector('.modal-shadow')).afterStyles({
          transform: 'translateY(0) scale(1)'
        }).keyframes([{
          offset: 0,
          opacity: '0',
...
const portraitToLandscapeTransition = (baseEl, opts, duration = 300) => {
  ...
  if (!presentingEl) {
    ...
    return (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)('portrait-to-landscape-transition');
  }
  const presentingElIsCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
  const presentingElRoot = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
  const bodyEl = document.body;
  const baseAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)('portrait-to-landscape-transition').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration);
  const presentingAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeStyles({
    transform: 'translateY(0)',
    'transform-origin': 'top center',
    overflow: 'hidden'
  ...
  if (!presentingElIsCardModal) {
    ...
    const root = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.g)(baseEl);
    const wrapperAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(root.querySelectorAll('.modal-wrapper, .modal-shadow')).fromTo('opacity', '1', '1'); // Keep wrapper visible in landscape
    const backdropAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 'var(--backdrop-opacity)'); // Keep backdrop visible
...
const landscapeToPortraitTransition = (baseEl, opts, duration = 300) => {
  ...
  if (!presentingEl) {
    // No transition needed for non-card modals
    return (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)('landscape-to-portrait-transition');
  }
  const presentingElIsCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
  const presentingElRoot = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.g)(presentingEl);
  const bodyEl = document.body;
  const baseAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)('landscape-to-portrait-transition').addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration);
  const presentingAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().beforeStyles({
    transform: 'translateY(0)',
    'transform-origin': 'top center',
    overflow: 'hidden'
  ...
  if (!presentingElIsCardModal) {
    ...
    // need to care about layering and modal-specific styles.
    const root = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.g)(baseEl);
    const wrapperAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(root.querySelectorAll('.modal-wrapper, .modal-shadow')).fromTo('opacity', '1', '1'); // Keep wrapper visible
    const backdropAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(root.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 'var(--backdrop-opacity)'); // Keep backdrop visible
...
const createEnterAnimation = () => {
  ...
  const wrapperAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().keyframes([{
    offset: 0,
    opacity: 0.01,
...
const mdEnterAnimation = (baseEl, opts) => {
  ...
  // all the breakpoints.
  !expandToScroll && (contentAnimation === null || contentAnimation === void 0 ? void 0 : contentAnimation.addElement(baseEl.querySelector('.ion-page')));
  const baseAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().addElement(baseEl).easing('cubic-bezier(0.36,0.66,0.04,1)').duration(280).addAnimation([backdropAnimation, wrapperAnimation]);
  if (contentAnimation) {
    baseAnimation.addAnimation(contentAnimation);
  }
  return baseAnimation;
...
const mdLeaveAnimation = (baseEl, opts) => {
  ...
  backdropAnimation.addElement(root.querySelector('ion-backdrop'));
  wrapperAnimation.addElement(root.querySelector('.modal-wrapper'));
  const baseAnimation = (0,_animation_BvhAtgca_js__WEBPACK_IMPORTED_MODULE_12__.c)().easing('cubic-bezier(0.47,0,0.745,0.715)').duration(200).addAnimation([backdropAnimation, wrapperAnimation]);
  return baseAnimation;
};
const createSheetGesture = (baseEl, backdropEl, wrapperEl, initialBreakpoint, backdropBreakpoint, animation, breakpoints = [], expandToScroll, getCurrentBreakpoint, onDismiss, onBreakpointChange) => {
  ...
  const enableBackdrop = () => {
     ...
     * the sheet.
     */
    baseEl.classList.remove(_overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.F);
  };
  const disableBackdrop = () => {
     ...
     */
    baseEl.classList.add(_overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.F);
  };
  /**
  ...
  const canStart = detail => {
     ...
     */
    const contentEl = (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.f)(detail.event.target);
    ...
    if (!expandToScroll && contentEl) {
      const scrollEl = (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.i)(contentEl) ? (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.g)(contentEl).querySelector('.inner-scroll') : contentEl;
  ...
  const onStart = detail => {
     ...
     */
    if (!expandToScroll) {
      const targetEl = (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.f)(detail.event.target);
      cachedScrollEl = targetEl && (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.i)(targetEl) ? (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.g)(targetEl).querySelector('.inner-scroll') : targetEl;
    }
    /**
    ...
    (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => {
      /**
  ...
  const onMove = detail => {
    ...
    offset = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.e)(0.0001, processedStep, maxStep);
...
const Modal = class {
  constructor(hostRef) {
    ...
    this.didPresent = (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionModalDidPresent", 7);
    this.willPresent = (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionModalWillPresent", 7);
    this.willDismiss = (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionModalWillDismiss", 7);
    this.didDismiss = (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionModalDidDismiss", 7);
    this.ionBreakpointDidChange = (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionBreakpointDidChange", 7);
    ...
    this.ionMount = (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionMount", 7);
    this.lockController = (0,_lock_controller_B_hirT0v_js__WEBPACK_IMPORTED_MODULE_5__.c)();
    this.triggerController = (0,_overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.e)();
    this.coreDelegate = (0,_framework_delegate_BLEBgH06_js__WEBPACK_IMPORTED_MODULE_3__.C)();
    ...
    this.onBackdropTap = () => {
      ...
      this.dismiss(undefined, _overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.B);
    };
  ...
  onWindowResize() {
    ...
    if ((0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_10__.b)(this) !== 'ios' || !this.presentingElement || this.enterAnimation || this.leaveAnimation) {
      return;
    }
  ...
  connectedCallback() {
    ...
    (0,_overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.j)(el);
    this.triggerChanged();
  }
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.b)(el, attributesToInherit);
    ...
    if (breakpoints !== undefined && initialBreakpoint !== undefined && !breakpoints.includes(initialBreakpoint)) {
      (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-modal] - Your breakpoints array must include the initialBreakpoint value.');
    }
    if (!((_a = this.htmlAttributes) === null || _a === void 0 ? void 0 : _a.id)) {
      (0,_overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.k)(this.el);
    }
  }
  componentDidLoad() {
    /**
     ...
     */
    if (this.isOpen === true) {
      (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.r)(() => this.present());
    }
  ...
  present() {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this2.usersElement = yield (0,_framework_delegate_BLEBgH06_js__WEBPACK_IMPORTED_MODULE_3__.a)(delegate, el, _this2.component, ['ion-page'], _this2.componentProps, inline);
      /**
       ...
       */
      if ((0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.h)(el)) {
        yield (0,_index_Dp7GXH1z_js__WEBPACK_IMPORTED_MODULE_9__.e)(_this2.usersElement);
        /**
        ...
        yield (0,_index_Dp7GXH1z_js__WEBPACK_IMPORTED_MODULE_9__.w)();
      }
      (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => _this2.el.classList.add('show-modal'));
       ...
       */
      if (hasCardModal && (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_10__.b)(_this2) === 'ios') {
        // Cache the original status bar color before the modal is presented
        _this2.statusBarStyle = yield StatusBar.getStyle();
        setCardStatusBarDark();
      }
      yield (0,_overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.f)(_this2, 'modalEnter', iosEnterAnimation, mdEnterAnimation, {
  ...
  initSwipeToClose() {
    var _this3 = this;
    var _a;
    if ((0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_10__.b)(this) !== 'ios') {
      return;
    }
    const {
      el
    ...
    const animationBuilder = this.leaveAnimation || _index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.e.get('modalLeave', iosLeaveAnimation);
    const ani = this.animation = animationBuilder(el, {
      presentingEl: this.presentingElement,
      expandToScroll: this.expandToScroll
    });
    const contentEl = (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.a)(el);
    if (!contentEl) {
      (0,_index_7UbSlv7N_js__WEBPACK_IMPORTED_MODULE_2__.p)(el);
      return;
    }
    ...
    this.gesture = createSwipeToCloseGesture(el, ani, statusBarStyle, () => {
      ...
      this.animation.onFinish(/*#__PURE__*/(0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
        yield _this3.dismiss(undefined, _overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.G);
  ...
  initSheetGesture() {
    ...
    const animationBuilder = this.enterAnimation || _index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.e.get('modalEnter', iosEnterAnimation);
  ...
  sheetOnDismiss() {
    ...
    this.animation.onFinish(/*#__PURE__*/(0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      yield _this4.dismiss(undefined, _overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.G);
  ...
  dismiss(data, role) {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      var _a;
      if (_this5.gestureAnimationDismissing && role !== _overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.G) {
        return false;
      }
      /**
       ...
       */
      const hasCardModal = presentingElement !== undefined;
      if (hasCardModal && (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_10__.b)(_this5) === 'ios') {
      ...
      const dismissed = yield (0,_overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.g)(_this5, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, {
        presentingEl: presentingElement,
      ...
      if (dismissed) {
        ...
        yield (0,_framework_delegate_BLEBgH06_js__WEBPACK_IMPORTED_MODULE_3__.d)(delegate, _this5.usersElement);
        (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.w)(() => _this5.el.classList.remove('show-modal'));
        if (_this5.animation) {
   ...
   */
  onDidDismiss() {
    return (0,_overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.h)(this.el, 'ionModalDidDismiss');
  }
  /**
   * Returns a promise that resolves when the modal will dismiss.
   */
  onWillDismiss() {
    return (0,_overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.h)(this.el, 'ionModalWillDismiss');
  }
  /**
  ...
  setCurrentBreakpoint(breakpoint) {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      if (!_this6.isSheetModal) {
        (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.f)('[ion-modal] - setCurrentBreakpoint is only supported on sheet modals.');
        return;
      }
      if (!_this6.breakpoints.includes(breakpoint)) {
        (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.f)(`[ion-modal] - Attempted to set invalid breakpoint value ${breakpoint}. Please double check that the breakpoint value is part of your defined breakpoints.`);
        return;
      }
      const {
        currentBreakpoint,
  ...
  reinitSwipeToClose() {
    ...
    if ((0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_10__.b)(this) !== 'ios' || !this.presentingElement) {
      return;
    }
  ...
  ensureCorrectModalPosition() {
    ...
    const root = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_4__.g)(el);
  ...
  render() {
    ...
    const mode = (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_10__.b)(this);
    ...
    return (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.d, Object.assign({
      ...
      class: Object.assign({
        ...
        'overlay-hidden': true,
        [_overlays_ZX_4_t_r_js__WEBPACK_IMPORTED_MODULE_7__.F]: focusTrap === false
      ...
      part: "backdrop"
    }), mode === 'ios' && (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
      key: 'e268f9cd310c3cf4e051b5b92524ce4fb70d005e',
      class: "modal-shadow"
    }), (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", Object.assign({
    ...
    }), showHandle && (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
