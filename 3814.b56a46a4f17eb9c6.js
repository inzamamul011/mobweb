...
/* harmony import */ var _haptic_DzAMWJuk_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./haptic-DzAMWJuk.js */ 90906);
...
const Toggle = class {
  constructor(hostRef) {
     ...
     */
    this.enableOnOffLabels = _index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.e.get('toggleOnOffLabels');
    /**
    ...
    this.onClick = ev => {
       ...
       * only trigger on iOS.
       */
      const enableHaptics = (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_4__.a)('ios');
      if (this.disabled) {
        return;
      }
      ev.preventDefault();
    ...
    this.getSwitchLabelIcon = (mode, checked) => {
      if (mode === 'md') {
        return checked ? _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_7__.f : _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_7__.r;
      }
      return checked ? _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_7__.r : _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_7__.g;
    };
  }
  disabledChanged() {
    if (this.gesture) {
  ...
  onMove(detail) {
    if (shouldToggle((0,_dir_C53feagD_js__WEBPACK_IMPORTED_MODULE_5__.i)(this.el), this.checked, detail.deltaX, -10)) {
      this.toggleChecked();
  ...
  renderToggleControl() {
    ...
    }, enableOnOffLabels && mode === 'ios' && [this.renderOnOffSwitchLabels(mode, true), this.renderOnOffSwitchLabels(mode, false)], (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)("div", {
  ...
  render() {
    ...
    return (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)(_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.d, {
      ...
      class: (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_6__.c)(color, {
        [mode]: true,
        'in-item': (0,_theme_DiVJyqlX_js__WEBPACK_IMPORTED_MODULE_6__.h)('ion-item', el),
