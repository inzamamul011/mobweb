...
const Input = class {
  ...
  componentWillLoad() {
    this.inheritedAttributes = Object.assign(Object.assign({}, (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.i)(this.el)), (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_4__.b)(this.el, ['tabindex', 'title', 'data-form-type', 'dir']));
  }
  connectedCallback() {
    const {
      el
    } = this;
    this.slotMutationController = (0,_input_utils_Bxa_DQ7_js__WEBPACK_IMPORTED_MODULE_5__.c)(el, ['label', 'start', 'end'], () => {
  ...
  render() {
    ...
    }, this.inheritedAttributes)), this.clearInput && !readonly && !disabled && (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
