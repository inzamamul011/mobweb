...
const Searchbar = class {
  constructor(hostRef) {
    ...
    this.ionClear = (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.c)(this, "ionClear", 7);
     ...
     */
    this.cancelButtonIcon = _index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.e.get('backButtonIcon', _index_DV3sJJW8_js__WEBPACK_IMPORTED_MODULE_5__.a);
    /**
  ...
  debounceChanged() {
     ...
     */
    this.ionInput = debounce === undefined ? originalIonInput !== null && originalIonInput !== void 0 ? originalIonInput : ionInput : (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_2__.d)(ionInput, debounce);
  }
  valueChanged() {
  ...
  componentWillLoad() {
    this.inheritedAttributes = Object.assign({}, (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_2__.b)(this.el, ['lang', 'dir']));
  }
  componentDidLoad() {
  ...
  getInputElement() {
    ...
    return (0,_Users_inzamamul_Documents_OfficeProjects_ionic_ts_operator_capacitor_ts_operator_capacitor_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      if (!_this3.nativeInput) {
        yield new Promise(resolve => (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_2__.c)(_this3.el, resolve));
      }
  ...
  positionPlaceholder() {
    ...
    if (this.shouldAlignLeft) {
      ...
      (0,_helpers_Tl8jw6S2_js__WEBPACK_IMPORTED_MODULE_2__.r)(() => {
  ...
  render() {
    ...
    const animated = this.animated && _index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.e.getBoolean('animated', true);
    const mode = (0,_ionic_global_DfbeLwcV_js__WEBPACK_IMPORTED_MODULE_6__.b)(this);
    ...
    const cancelButton = this.showCancelButton !== 'never' && (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.h)("button", {
      ...
      "aria-hidden": "true"
    }, mode === 'md' ? (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
      "aria-hidden": "true",
      mode: mode,
    ...
    }, this.inheritedAttributes)), mode === 'md' && cancelButton, (0,_index_IGIE5vDm_js__WEBPACK_IMPORTED_MODULE_1__.h)("ion-icon", {
