...
const PickerColumn = class {
  constructor(hostRef) {
    ...
    this.initializeScrollListener = () => {
       ...
       */
      const enableHaptics = (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_5__.a)('ios');
      const {
        el,
        scrollEl
      } = this;
    ...
    this.onKeyDown = ev => {
       ...
       */
      const mobile = (0,_ionic_global_CTSyufhF_js__WEBPACK_IMPORTED_MODULE_5__.a)('mobile');
      let newOption = null;
      switch (ev.key) {
        case 'ArrowDown':
  ...
  componentWillLoad() {
    ...
    const visibleCallback = entries => {
      ...
      if (ev.isIntersecting) {
         ...
         */
        const oldActive = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_3__.g)(el).querySelector(`.${PICKER_ITEM_ACTIVE_CLASS}`);
        if (oldActive) {
  ...
  render() {
    ...
    }, this.renderAssistiveFocusable(), (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_1__.h)("slot", {
