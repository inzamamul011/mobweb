"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([[9977],{
...
const ProgressBar = class {
  ...
  render() {
    ...
    const paused = _index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_0__.e.getBoolean('_testing');
...
const renderIndeterminate = () => {
  return (0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
    part: "track",
...
const renderProgress = (value, buffer) => {
  const finalValue = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_1__.e)(0, value, 1);
  const finalBuffer = (0,_helpers_8KSQQGQy_js__WEBPACK_IMPORTED_MODULE_1__.e)(0, buffer, 1);
  return [(0,_index_4DxY6_gG_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", {
    part: "progress",
    class: "progress",
    style: {
